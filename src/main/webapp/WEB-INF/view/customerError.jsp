...
<div class="container">
    ...
    <div class="badge-important well well-small">
        ...
        <c:forEach items="${productError}" var="productError" >
            <p><span class="label label-important">а баОаЖаАаЛаЕаНаИб <c:out value="${productError.date}"/> аНаА <c:out value="${productError.warehouse}"/> аПаОбббаПаЛаЕаНаИаЙ баОаВаАбаА <c:out value="${productError.product}"/> аНаЕ аБбаЛаО!</span></p>
        </c:forEach>
        <p><span class="label label-important">аббаАаЛбаНаОаЙ баОаВаАб аДаОаБаАаВаЛаЕаН аВ "а аАббаОаД"</span></p>
    </div>
